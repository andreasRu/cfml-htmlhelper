...
cftimer( label="minifyHTML & encodeTrustedHtml", type="outline"){
	...
	a=htmlHelperService.minifyHTML( htmlHelperService.encodeTrustedHtml( htmlcontent ) );
	
}

cftimer( label="minifyHTML", type="outline"){

	a=htmlHelperService.minifyHTML( htmlcontent );
	
}

cftimer( label="encodeTrustedHtml", type="outline"){

	a=htmlHelperService.encodeTrustedHtml( htmlcontent );
